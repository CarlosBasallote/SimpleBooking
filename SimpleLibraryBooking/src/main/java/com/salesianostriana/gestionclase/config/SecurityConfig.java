package com.salesianostriana.gestionclase.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(
				...
				.antMatchers("/resources/**").authenticated().and().formLogin().loginPage("/login") // Ruta del controlador
																								// del formulario de
																								// login
				.defaultSuccessUrl("/index") // Ruta de redirección en caso de éxito.
